...
const What = (props: {multiplier: number, ispc: any}) => {
  return (
    <div className="relative">
      ...
      <div
      style={{marginTop: props.multiplier==1.6969?-props.multiplier*200:-props.multiplier*88}}
      className="text-black -mt-[12rem] text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <p
        style={{fontSize: props.multiplier==1.6969?props.multiplier*10:props.multiplier*14}}
        className="a mb-4">
